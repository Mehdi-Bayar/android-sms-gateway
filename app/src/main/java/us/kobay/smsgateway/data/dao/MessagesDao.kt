package us.kobay.smsgateway.data.dao
...
import us.kobay.smsgateway.data.entities.MessageRecipient
import us.kobay.smsgateway.data.entities.MessageState
import us.kobay.smsgateway.data.entities.MessageWithRecipients
import us.kobay.smsgateway.data.entities.MessagesStats
import us.kobay.smsgateway.data.entities.RecipientState
...
interface MessagesDao {
    ...
    fun _insertRecipientStatesByMessage(
        messageId: String,
        state: us.kobay.smsgateway.domain.ProcessingState
    )
    ...
    fun _updateMessageState(id: String, state: us.kobay.smsgateway.domain.ProcessingState)

    fun updateMessageState(id: String, state: us.kobay.smsgateway.domain.ProcessingState) {
    ...
    fun setMessageProcessed(id: String) {
        ...
        _insertMessageState(
            MessageState(
                id,
                us.kobay.smsgateway.domain.ProcessingState.Processed,
                System.currentTimeMillis()
            )
        )
    }
