...
import us.kobay.smsgateway.BuildConfig
import us.kobay.smsgateway.R
import us.kobay.smsgateway.domain.EntitySource
import us.kobay.smsgateway.domain.ProcessingState
import us.kobay.smsgateway.extensions.configure
...
import us.kobay.smsgateway.modules.localserver.domain.Device
import us.kobay.smsgateway.modules.localserver.domain.PostMessageRequest
import us.kobay.smsgateway.modules.localserver.domain.PostMessageResponse
import us.kobay.smsgateway.modules.localserver.routes.LogsRoutes
import us.kobay.smsgateway.modules.localserver.routes.WebhooksRoutes
import us.kobay.smsgateway.modules.messages.MessagesService
import us.kobay.smsgateway.modules.messages.data.SendRequest
import us.kobay.smsgateway.modules.notifications.NotificationsService
    ...
    private val server by lazy {
        embeddedServer(
            ...
            install(ContentNegotiation) {
                gson {
                    if (us.kobay.smsgateway.BuildConfig.DEBUG) {
                        setPrettyPrinting()
                    }
                    configure()
                }
                    ...
                    route("/message") {
                        post {
                            ...
                            val sendRequest = SendRequest(
                                EntitySource.Local,
                                us.kobay.smsgateway.modules.messages.data.Message(
                                    request.id ?: NanoIdUtils.randomNanoId(),
                                    request.message,
                                    request.phoneNumbers,
                                    request.isEncrypted ?: false
                                ),
                                us.kobay.smsgateway.modules.messages.data.SendParams(
